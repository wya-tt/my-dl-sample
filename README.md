<!-- 仓库级 README（中英双语）。
     GitHub 的 Markdown 不执行 JS，无法做真正的「点击切换」，
     因此用「真实标题锚点 + 顶部跳转链接 + 可折叠分段」实现双语导航。 -->
...
<p align="right"><a href="#english">Switch to English ↗</a> · <a href="#-my-dl-sample">⬆ 回到顶部</a></p>
...
<p align="right"><a href="#中文">切换到中文 ↗</a> · <a href="#-my-dl-sample">⬆ Back to top</a></p>
